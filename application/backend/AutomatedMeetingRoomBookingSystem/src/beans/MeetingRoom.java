...
public class MeetingRoom {
    ...
    public String toString() {
        return new StringJoiner(", ", MeetingRoom.class.getSimpleName() + "[", "]")
                .add("meetingRoomName='" + meetingRoomName + "'")
                .add("seatingCapacity=" + seatingCapacity)
                .add("ratings=" + ratings)
                .add("amenities=" + amenities)
                .add("perHourCost=" + perHourCost)
                .add("numOfMeetingsHeld=" + numOfMeetingsHeld)
                .toString();
    }
    ...
    public boolean equals(Object obj) {
        if(obj==null)
            return false;
        return (obj instanceof MeetingRoom &&
                ((MeetingRoom)obj).meetingRoomName.equals(this.meetingRoomName)
        );
    }
}
