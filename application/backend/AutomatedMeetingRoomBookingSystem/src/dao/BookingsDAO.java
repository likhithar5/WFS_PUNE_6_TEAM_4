...
public interface BookingsDAO {
     ...
     * @param bookingId The id of the booking record that has to be fetched from the database.
     * @return Booking
     * @throws SQLException For any Sql related exceptions.
     * @throws BookingNotFoundException When the requested booking with given id does not exist.
     * @author Sayantan Das
     * */
